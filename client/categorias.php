...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            <hr>
                <a class="btn btn-outline-dark" style="margin-left: 300px;" href="finan.php">Finanças</a>
                <a class="btn btn-outline-dark ml-4" href="lazer.php">Lazer</a>
                <a class="btn btn-outline-dark ml-4" href="pessoal.php">Pessoal</a>
                <a class="btn btn-outline-dark ml-4" href="saude.php">Saúde</a>
                <a class="btn btn-outline-dark ml-4 " href="trabalho.php">Trabalho</a>
