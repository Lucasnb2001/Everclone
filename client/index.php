...
<html lang="pt-br">
    <head>
        ...
        <script>
            function editar(id, nome, conteudo, categoria){
                    ...
                    <div class="card">
                        <div class="card-header pb-5">
                            ...
                            <div class="float-right">
                                <a onclick="editar(<?php print_r($nota->id) ?>, '<?php print_r($nota->title) ?>', '<?php print_r($nota->body) ?>', '<?php print_r($nota->category_id) ?>')" class="btn btn-dark"><i class="fas fa-edit" style="color: #F7F7F7;"></i></a>
                        ...
                        <div id="tag_<?php print_r($nota->id) ?>" class="card-footer text-begin">
                            ...
                            <?php foreach($tagsGuardadas as $indice => $note_tag){?>
                                <?php if($note_tag->note_id == $nota->id){?>
                                    <?php
